...
//				    .on("mouseover",function(d, i){ return bP.selectSegment(data, p, i); })
				    .on("click", function(d,i) { d3.select(this).classed("selected",true); return bP.selectSegment(data, p, i);})
//				    .on("mouseout",function(d, i) { if ((d3.select(this).classed("selected")==false)) {return bP.deSelectSegment(data, p, i);}  });	            
		    });
		});	
	}
